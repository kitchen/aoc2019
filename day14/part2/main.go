...
import (
	...
	"github.com/kitchen/aoc2019/day14"
)

func main() {
	specs := `2 RWPCH => 9 PVTL
1 FHFH => 4 BLPJK
146 ORE => 5 VJNBT
...
1 WJDF, 1 LKPQG => 4 XSNKB`
	...
	chemicals := day14.NewChemicals(specs)

	limit := 1000000000000
	for i := 3250000; ; i++ {
		oreNeeded := chemicals.OreNeededForFuel(i)
		if oreNeeded > limit {
			break
		}
		fmt.Printf("ore needed for %v fuel: %v\n", i, oreNeeded)
	}
}
