...
type day7Suite struct {
	suite.Suite
}

func (suite *day7Suite) SetupTest() {
}

func (suite *day7Suite) TestDay2Stuff() {
	program := []int{1, 9, 10, 3, 2, 3, 11, 0, 99, 30, 40, 50}
	final, _, _ := Run(program, 0, []int{0})
...
func (suite *day7Suite) TestExample1() {
...
func (suite *day7Suite) TestExample2() {
...
func (suite *day7Suite) TestExample3() {
